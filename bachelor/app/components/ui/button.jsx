...
const buttonVariants = cva(
  "inline-flex items-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary  justify-center text-primary-foreground hover:bg-primary/90",
        destructive:
          "bg-destructive  justify-center text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input  justify-center bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-secondary  justify-center text-secondary-foreground hover:bg-secondary/80",
