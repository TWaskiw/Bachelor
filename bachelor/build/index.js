...
function App() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("body", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Toaster, { richColors: !0 }, void 0, !1, {
        fileName: "app/root.jsx",
        lineNumber: 43,
        columnNumber: 9
      }, this)
...
async function action({ request, params }) {
  ...
  try {
    ...
    if (actionType)
      switch (actionType) {
        case "updateProduct":
          let name = form.get("name").trim(), stock = form.get("stock").trim();
          if (!name)
...
function AdminPage() {
  ...
  return console.log(success), console.log(actionData), (0, import_react20.useEffect)(() => {
